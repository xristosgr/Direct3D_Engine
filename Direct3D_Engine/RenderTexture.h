...
public:
	RenderTexture();
	bool Initialize(ID3D11Device* device, int, int);
	...
	bool InitializeCubeTexture(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int, int,std::vector<std::string>&);
